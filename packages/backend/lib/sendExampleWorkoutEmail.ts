...
import { exampleWorkoutEmail } from "@lib/index";

export const sendExampleWorkoutEmail = async (jobData: exampleWorkoutEmail) => {
  ...
  const { data, error } = await resend.emails.send({
    ...
    subject: "SAMSON AI: Example Workout",
...
<tr>
  <td align="center" style="padding:40px;text-align:center">
    <h4
      style="margin:8px 0 0 0;font-weight:700;color:rgb(236, 166, 39)">⚠️ Example Email</h4>
    <p
    ...
    <p
     ...
     <h3>💪 Warm Up</h3><br />- Jumping Jacks (5 mins)<br />- Arm Circles (2 mins)<br />- Light Jogging on Treadmill (5 mins, speed 4.0, incline 0)<br /><h3>🏋️ Main Workout</h3><br />- Barbell Squats (3 sets of 8 reps, 70% of 1RM)<br />- Bench Press (3 sets of 8 reps, 70% of 1RM)<br />- Dumbbell Rows (3 sets of 10 reps per arm, 25 lbs)<br />- Pull-ups (3 sets to failure)<br /><h3>🧘 Warm Down</h3><br />- Static Quad Stretch (1 min per leg)<br />- Hamstring Stretch (1 min per leg)<br />- Shoulder Stretch (1 min per arm)
    </p>
    <a
